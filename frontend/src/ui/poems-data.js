export const POEMS = {
  "demain-hugo": {
    ...
    year: "1856",
    intro:
      "Écrit en hommage à sa fille Léopoldine, disparue à 19 ans. Un des plus beaux textes français sur le deuil et l'amour qui demeure.",
    stanzas: [
      [
    ...
    note: "Domaine public — Les Contemplations, 1856.",
  },
  ...
  "invictus-henley": {
    ...
    year: "1875",
    intro:
      "Écrit à l'hôpital, alors que le poète luttait contre la tuberculose et venait d'être amputé d'une jambe. Un hymne à la force intérieure face à l'épreuve.",
    stanzas: [
      [
      ...
      [
        "En ce lieu de châtiments et de pleurs,",
    ...
    note: "Domaine public — traduction française du poème de 1875.",
  },

  "si-kipling": {
    title: "Si",
    author: "Rudyard Kipling (trad. André Maurois)",
    year: "1910",
    intro:
      "Adressé à son fils, ce poème énumère les conditions du courage tranquille. La traduction d'André Maurois (1918) est devenue plus célèbre en France que l'original anglais.",
    stanzas: [
      [
    ...
    note: "Domaine public — traduction d'André Maurois, 1918.",
  },
  ...
  "albatros-baudelaire": {
    ...
    year: "1859",
    intro:
      "Image du poète exilé sur terre : majestueux dans son élément, maladroit dès qu'on l'en arrache. Une méditation sur ce qu'on perd quand on ne peut plus déployer ses ailes.",
    stanzas: [
      [
